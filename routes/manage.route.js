...
const {addSchedule,getAllSchedule,getAllCanceledSchedule,getAllActiveSchedule,getAllActiveScheduleInRoute,bookTicketFromSchedule,assignBusToSchedule,cancelSchedule,undoCancelSchedule,myBookedTicketList,myPassangerList}= require("../controllers/schedule.controller")
...
router.put('/mypassanger',userauth,myPassangerList,errorHandler)
