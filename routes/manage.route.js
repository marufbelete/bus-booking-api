...
router.get('/getorganizationbyid/:id',userauth,authaAdminCasher,getOrganizationById,errorHandler)
router.get('/getorganizationbycode/:id',userauth,authaAdminCasher,getOrganizationByCode,errorHandler)
router.put('/updateorganization/:id',userauth,authaAdminCasher,updateOrganization,errorHandler)
router.delete('/deleteorganization/:id',userauth,authaAdminCasher,deleteOrganization,errorHandler)
//hotel and pension
